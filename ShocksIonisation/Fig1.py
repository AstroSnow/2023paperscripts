...
axs.plot(xsm/5.0,dsm['vx_p'],'k--',label='vx (MHD)',linewidth=lthick)
...
axs.text(-0.00085,-0.115,'(downstream)',color='k',fontsize=16)
axs.text(0.001,-0.1,'pre-shock',color='k',fontsize=16)
axs.text(0.001,-0.115,'(upstream)',color='k',fontsize=16)
axs.text(0.00001,-0.2,'finite-width',color='k',fontsize=16)
#axs.plot([xs[bn],xs[bn]],[-1,1],'r--')
#axs.plot([xs[b],xs[b]],[-1,1],'b--')
axs.set_xlim([xmin,xmax])
axs.set_ylim([-0.21,0.01])
axs.legend()
axs.set_xlabel('$x$')
