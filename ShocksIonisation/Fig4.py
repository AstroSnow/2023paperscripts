...
#fname='../simdata/T_6220_n_7.5e16/' ;xmin=0.068;xmax=0.08; etime=40;T0=6220
#fname='../simdata/CorrectedSims/uptestisca/' ;xmin=0.145;xmax=0.1462; T0=6220.0; etime=60;sname='shocksub2_plot_upc_corrected.png'
#fname='../simdata/CorrectedSims/midtestisca/';xmin=0.09;xmax=0.12; T0=5030.0; etime=100; sname='shocksub2_plot_midc_corrected.png'
#fname='../simdata/CorrectedSims/lowisca/';xmin=0.06;xmax=0.12; T0=5180.0; etime=100; sname='shocksub2_plot_lowc_corrected.png'
#fname='../simdata/CorrectedSims/T6220_n7.5e16_t10000/';xmin=0.14;xmax=0.15; T0=6220.0; etime=10; sname='shocksub2_plot_T6220_cor.png'
#fname='../simdata/CorrectedSims/T6000_n7.5e16_t10000/';xmin=0.14;xmax=0.15; T0=6000.0; etime=10; sname='shocksub2_plot_T6000_cor.png'
#fname='../simdata/CorrectedSims/T5800_n7.5e16_t10000/';xmin=0.14;xmax=0.147; T0=5800.0; etime=10; sname='shocksub2_plot_T5800_cor.png'
#fname='../simdata/CorrectedSims/T5400_n7.5e16_t10000/';xmin=0.1;xmax=0.15; T0=5400.0; etime=10; sname='shocksub2_plot_T6220_cor.png'
fname='../simdata/CorrectedSims/T5600_n7.5e16_t100000/';xmin=0.101;xmax=0.105; T0=5600.0; etime=10; sname='shocksub2_plot_test.png'
#fname='../simdata/CorrectedSims/T5000_n7.5e16_t100000/';xmin=0.08;xmax=0.12; T0=5000.0; etime=10; sname='shocksub2_plot_T6220_cor.png'
#fname='../simdata/CorrectedSims/T5180_n6.5e18_t100000/' ;xmin=0.08;xmax=0.12; etime=10;T0=5180; sname='shocksub2_plot_test.png'
#fname='../simdata/CorrectedSims/T5500_n6.5e18_t100000/' ;xmin=0.07;xmax=0.13; etime=10;T0=5500; sname='shocksub2_plot_test.png'
#fname='../simdata/CorrectedSims/T6000_n6.5e18_t100000/' ;xmin=0.05;xmax=0.09; etime=10;T0=6000; sname='shocksub2_plot_test.png'
...
if fname=='../simdata/CorrectedSims/uptestisca/':
    bn2=np.argmin(np.gradient(ds['vx_n'][44700:44800]))+44700 #neutral shock location
    axs[0,0].fill_between([xs[bn2],0.2],[-1,-1], [0.2,0.2], alpha=0.3,facecolor='green')
    axs[0,0].fill_between([-0.004,xs[bn]],[-1,-1], [0.2,0.2], alpha=0.3,facecolor='green')
    axs[0,0].text(-0.0004,-0.4,'post-shock',color='k')
    axs[0,0].text(0.0004,-0.4,'pre-shock',color='k')
    axs[0,0].text(0.00003,-0.5,'finite-width',color='k')
    axs[0,0].plot([xs[bn],xs[bn]],[-1,1],'r--')
    axs[0,0].plot([xs[bn2],xs[bn2]],[-1,1],'r--')
    axs[0,0].plot([xs[b],xs[b]],[-1,1],'b--')
    axs[0,0].set_ylim([-1.01,0.1])
    

axs[0,1].plot(xs,-(ds['vx_n']-vsn)/csn,label='Neutral Sonic',color='r',linewidth=lthick)
...
if fname=='../simdata/T_6220_long/Data/':
    axs[0,1].legend(loc=[0.1,0.65])
if fname=='../simdata/isca_midc_ltest/Data/':    
    axs[0,1].legend(loc=[0.55,0.15])
if fname=='../simdata/isca_lowc_long/Data/':    
    axs[0,1].legend(loc=[0.55,0.15])
if fname=='../simdata/CorrectedSims/uptestisca/':    
    axs[0,1].legend()#loc=[0.55,0.15])
...
if fname=='../simdata/T_6220_long/Data/':
    ...
    axs[1,0].text(0.0, 1.0, 'c', transform=axs[1,0].transAxes + trans,
            fontsize='medium', verticalalignment='top', fontfamily='serif',
            bbox=dict(facecolor='0.7', edgecolor='none', pad=3.0))
    trans = mtransforms.ScaledTranslation(10/72, -25/72, fig.dpi_scale_trans)
...
if fname=='../simdata/isca_midc_ltest/Data/':    
    ...
    axs[1,0].text(0.0, 1.0, 'c', transform=axs[1,0].transAxes + trans,
            fontsize='medium', verticalalignment='top', fontfamily='serif',
            bbox=dict(facecolor='0.7', edgecolor='none', pad=3.0))
    trans = mtransforms.ScaledTranslation(10/72, -12/72, fig.dpi_scale_trans)
    axs[1,1].text(0.0, 1.0, 'd', transform=axs[1,1].transAxes + trans,
            fontsize='medium', verticalalignment='top', fontfamily='serif',
            bbox=dict(facecolor='0.7', edgecolor='none', pad=3.0))
if fname=='../simdata/isca_lowc_long/Data/':    
